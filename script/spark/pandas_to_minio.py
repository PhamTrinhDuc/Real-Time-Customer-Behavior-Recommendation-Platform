...
def delte_bucket_if_not_exists(client, bucket_name: str): 
...
def pandas_to_minio(tables: list):
...
if __name__ == "__main__":
    TABLES = ["orders", "order_items", "payments", "customers", "products", "categories"]
    pandas_to_minio(tables="categories")